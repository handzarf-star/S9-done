...
export const APPROACH_STEPS: ProcessStep[] = [
  {
    ...
    descBs: 'Mapiramo Vaše stvarne operacije i jasno Vam pokazujemo šta je tehnički izvodivo, uključujući AI, tamo gdje donosi pravu vrijednost, a gdje ne.',
    descEn: 'We map your processes and walk your team through what is actually possible, AI included where it fits, and where it does not.',
  },
  {
    id: 'roadmap',
    titleBs: 'Plan uvođenja sa brzim rezultatima',
    titleEn: 'A roadmap, quick wins first',
    descBs: 'Definišemo korake koji donose najveću operativnu uštedu uz najmanji rizik i krećemo od njih, kako biste konkretan pomak vidjeli odmah.',
  ...
  },
  {
    ...
    descBs: 'Ne morate zapošljavati nove inženjere. Postavku, integraciju i tehničko održavanje preuzimamo mi. Vaš tim se i dalje bavi svojim primarnim poslom.',
    descEn: 'You do not need to hire an IT person for this to work. Setup, integration and upkeep are our job. Your team keeps doing its own.',
  },
  {
    id: 'support',
